...
7. Using the github's web interface, add the second half of the lyrics and make a commit
   with the name "finish my song".

8. Make a pull in the local repository and make sure that the commit you created on
   github is pulled up and you have all the lyrics.


SELF-REVIEW:
------------

- Git is installed and SSH keys are configured with GitHub
- Local repository is cloned from GitHub
- song.txt file contains the complete lyrics after pull
- Both commits are visible in git log

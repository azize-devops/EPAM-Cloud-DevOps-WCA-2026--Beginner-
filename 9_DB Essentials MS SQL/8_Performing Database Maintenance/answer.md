...
| Status | FragPct |
|--------|---------|
| BEFORE REORGANIZE | ~90% |
| AFTER REORGANIZE | ~10-30% (reduced but not eliminated) |
...
| Status | FragPct |
|--------|---------|
| BEFORE REBUILD | ~10-30% (after reorganize) or ~90% (if skipped reorganize) |
| AFTER REBUILD | ~0% (completely defragmented) |

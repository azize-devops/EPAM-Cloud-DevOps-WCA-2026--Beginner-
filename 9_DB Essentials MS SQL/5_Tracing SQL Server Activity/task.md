...
Open SSMS and connect to your instance. Create two global temporary tables (`##Employees`, `##Suppliers`) and insert sample data into both tables:
...
Open TWO separate query windows in SSMS. Execute commands step-by-step, alternating between sessions. Observe the deadlock occur.

| Session 1 (Query Window 1) | Session 2 (Query Window 2) |
|----------------------------|----------------------------|
| **Step 1:** `BEGIN TRAN;` | |
| | **Step 2:** `BEGIN TRAN;` |
| **Step 3:** `UPDATE ##Employees SET EmpName='Christie' WHERE EmpId = 1` | |
| | **Step 4:** `UPDATE ##Suppliers SET Fax = N'444-9898' WHERE SupplierId = 1` |
| **Step 5:** `UPDATE ##Suppliers SET Fax = N'888-4343' WHERE SupplierId = 1` | |
| *Session 1 is BLOCKED* | |
| | **Step 6:** `UPDATE ##Employees SET Phone = N'777-8888' WHERE EmpId = 1` |

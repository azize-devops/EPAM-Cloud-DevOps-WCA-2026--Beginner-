...
| `UPDATE Employees SET EmpName = 'Christie' WHERE EmpId = 1` | |
| | `UPDATE Suppliers SET Fax = N'444-9898' WHERE SupplierId = 1` |
| `UPDATE Suppliers SET Fax = N'888-4343' WHERE SupplierId = 1` | |
| *blocked* | `UPDATE Employees SET Phone = N'777-8888' WHERE EmpId = 1` |
| | *blocked* |
| **DEADLOCK OCCURS!** | |

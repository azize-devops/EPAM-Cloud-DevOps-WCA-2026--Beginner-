...
14. Find in the header of one of them the MAC addresses of the source and
    destination, the IP addresses of the source and destination.

15. Find a pair of Echo Request and Echo Reply packets, find the value of the
    TTL field in them, and explain why it has a different value.

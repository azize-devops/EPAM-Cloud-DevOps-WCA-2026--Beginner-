...
Example Answer:
- Smallest packet: 54 bytes (TCP ACK)
- Largest packet: 1514 bytes (TCP segment with data)
...
(Same screenshot as Task 8 can be used - highlight the row with highest count)
...
[ ] SCREENSHOT 1  - Wireshark main interface after installation
[ ] SCREENSHOT 2  - Interface selection and capture starting
[ ] SCREENSHOT 3  - Browser showing epam.com website
[ ] SCREENSHOT 4  - Command Prompt with ping 8.8.8.8 results
[ ] SCREENSHOT 5  - Wireshark with captured packets (after stop)
[ ] SCREENSHOT 6  - Statistics > Packet Lengths (smallest/largest)
[ ] SCREENSHOT 7  - Statistics > Packet Lengths (most common - can combine with 6)
[ ] SCREENSHOT 8  - Statistics > Endpoints > IPv4 (sorted by Tx Bytes)
[ ] SCREENSHOT 9  - Statistics > Endpoints > IPv4 (sorted by Rx Bytes)
[ ] SCREENSHOT 10 - Statistics > Protocol Hierarchy (TCP, UDP, ICMP percentages)
[ ] SCREENSHOT 11 - Wireshark with "icmp" filter applied
[ ] SCREENSHOT 12 - Packet details: Ethernet II and IPv4 headers expanded
[ ] SCREENSHOT 13a - Echo Request packet with TTL field visible
[ ] SCREENSHOT 13b - Echo Reply packet with TTL field visible
[ ] SCREENSHOT 14 - Wireshark with "tcp.flags.syn == 1" filter applied

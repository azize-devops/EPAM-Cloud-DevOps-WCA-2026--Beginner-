...
1. Write an advanced function to show the size of files in specific folder
   and sort all of them by size.

2. Write an advanced function to delete file from a specific folder if file
   size greater than specified size in Kb.
